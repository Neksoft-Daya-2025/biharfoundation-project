...
@section('page-description', 'Manage your operations')
...
<div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2">{{ number_format($visitors_last_30 ?? 0) }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2">{{ number_format($total_orders ?? 0) }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2">{{ number_format($pending_orders ?? 0) }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2">{{ format_money($revenue_this_month ?? 0) }}</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-gray-900 mt-2">{{ number_format($products_count ?? 0) }}</p>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            <a href="{{ route('dashboard.analytics') }}" class="flex items-center gap-4 p-4 rounded-lg border border-gray-200 hover:border-[#937237] hover:bg-amber-50/50 transition-all">
            ...
            <a href="{{ route('dashboard.customers') }}" class="flex items-center gap-4 p-4 rounded-lg border border-gray-200 hover:border-[#937237] hover:bg-amber-50/50 transition-all">
            ...
            <a href="{{ route('dashboard.orders') }}" class="flex items-center gap-4 p-4 rounded-lg border border-gray-200 hover:border-[#937237] hover:bg-amber-50/50 transition-all">
            ...
            <a href="{{ route('dashboard.products') }}" class="flex items-center gap-4 p-4 rounded-lg border border-gray-200 hover:border-[#937237] hover:bg-amber-50/50 transition-all">
            ...
            <a href="{{ route('dashboard.blog') }}" class="flex items-center gap-4 p-4 rounded-lg border border-gray-200 hover:border-[#937237] hover:bg-amber-50/50 transition-all">
            ...
            <a href="{{ route('dashboard.settings') }}" class="flex items-center gap-4 p-4 rounded-lg border border-gray-200 hover:border-[#937237] hover:bg-amber-50/50 transition-all">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-xl font-bold text-gray-900 mt-1">{{ config('themes.'.current_theme().'.name', current_theme()) }}</p>
                <p class="text-xs text-gray-500 mt-1">Used for the public site when you add routes.</p>
            </div>
            <div class="flex items-center gap-2">
                <a href="{{ route('theme.preview') }}" target="_blank" rel="noopener" class="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-lg font-medium transition-colors flex items-center gap-2 text-sm">
                    <i data-feather="eye" class="w-4 h-4"></i>
                    Preview theme
                </a>
                <a href="{{ route('dashboard.settings') }}" class="px-4 py-2 bg-[#937237] hover:bg-[#7a5d2e] text-white rounded-lg font-medium transition-colors flex items-center gap-2 text-sm">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <div class="space-y-3">
            <div class="flex items-center justify-between py-2 border-b border-gray-100">
                ...
                <span class="text-sm font-medium text-gray-900">{{ config('themes.'.current_theme().'.name', current_theme()) }}</span>
            </div>
            <div class="flex items-center justify-between py-2 border-b border-gray-100">
