      ...
      <section className="py-24 bg-paper">
        <div className="max-w-4xl mx-auto px-6 text-center scroll-reveal">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/membership" className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-saffron text-white font-bold uppercase tracking-widest text-xs rounded-full hover:bg-ink transition-all">Become a Member</Link>
            <Link to="/contact" className="inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-ink text-ink font-bold uppercase tracking-widest text-xs rounded-full hover:bg-ink hover:text-white transition-all">Get in Touch</Link>
          </div>
        </div>
      </section>
    </div>
