    ...
    <footer className="bg-slate-900 text-slate-300 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8 mb-12">
          ...
          <div className="lg:col-span-3">
            ...
            <ul className="space-y-4 text-sm">
              <li>
                <Link to="/events/india-house-visit-2025" className="flex gap-3 group hover:text-saffron transition-colors">
                  <img 
                    src="/images/Past Events/India House Visit 2025/WhatsApp-Image-2025-12-02-at-15.11.40_70340508.webp" 
                    alt="India House Visit" 
                    className="w-16 h-16 object-cover rounded-md shrink-0"
                  />
                  <span className="leading-relaxed line-clamp-3">Stichting BFNC Netherlands Chapter Team Visits India House: A Memorable and Meaningful Engagement</span>
                </Link>
              </li>
              <li>
                <Link to="/events/chhath-puja-2025" className="flex gap-3 group hover:text-saffron transition-colors">
                  <img 
                    src="/images/Past Events/Chhath puja 2025/573058541_122184944006579269_8084723986992163924_n-1 (1).webp" 
                    alt="Chhath Puja 2025" 
                    className="w-16 h-16 object-cover rounded-md shrink-0"
                  />
                  <span className="leading-relaxed line-clamp-3">Chhath Puja 2025 Celebrated in the Netherlands by Bihar Foundation Netherlands</span>
                </Link>
              </li>
              <li>
                <Link to="/events/bihar-diwas-2025" className="flex gap-3 group hover:text-saffron transition-colors">
                  <img 
                    src="/images/Past Events/Bihar diwas 2025/480972446_122145562700579269_3570874758825703100_n-1.webp" 
                    alt="Bihar Diwas 2025" 
                    className="w-16 h-16 object-cover rounded-md shrink-0"
                  />
                  <span className="leading-relaxed line-clamp-3">Bihar Diwas 2025: A Grand Celebration of Culture, Community, and Progress</span>
                </Link>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs">
          <p>© 2026 Stichting Bihar Foundation Netherlands Chapter. All Rights Reserved.</p>
          <p>
