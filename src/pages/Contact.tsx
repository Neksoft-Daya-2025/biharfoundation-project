          ...
          <div className="scroll-reveal">
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button type="submit" className="w-full inline-flex items-center justify-center gap-3 px-8 py-5 bg-saffron text-white font-bold uppercase tracking-widest text-sm rounded-full hover:bg-ink transition-all">
