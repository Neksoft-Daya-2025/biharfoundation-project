...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="text" id="image" name="image" value="<?php echo e(old('image', $event && $event->image && (str_starts_with($event->image, 'http://') || str_starts_with($event->image, 'https://')) ? $event->image : '')); ?>" placeholder="https://... or images/your-file.png"
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\MUGDHA\Downloads\Downloads\Websites\Bihar foundation\bihar backend\resources\views/dashboard/events/form.blade.php ENDPATH**/ ?>